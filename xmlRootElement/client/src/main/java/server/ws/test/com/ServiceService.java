...
public class ServiceService extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/xmlRootElement/ServiceService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/jshepher/git-casework/redhat/xmlRootElement/client/src/main/resources/TestWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
